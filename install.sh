...
# wget https://data.broadinstitute.org/alkesgroup/Eagle/downloads/Eagle_v2.3.tar.gz
# tar xzvf Eagle_v2.3.tar.gz -C ~/bin/ Eagle_v2.3/eagle --strip-components=1
# tar xzvf Eagle_v2.3.tar.gz -C ~/res/ Eagle_v2.3/tables/genetic_map_hg19_withX.txt.gz --strip-components=2
#
...
# wget ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh37p13/VCF/00-All{,_papu}.vcf.{gz,gz.md5,gz.tbi}
...
# cp /panfs/panasas01/sscm/em13383/phd/alspac/genetics/dbNSFP/dbNSFP.txt.gz ~/res/dbNSFP.txt.gz
# cp /panfs/panasas01/sscm/em13383/phd/alspac/genetics/dbNSFP/dbNSFP.txt.gz.tbi ~/res/dbNSFP.txt.gz.tbi
...
bash ~/programs/gwaspipeline/makecpg.sh
